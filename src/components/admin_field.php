...
<div class="field_wrap js-field" <?php if ($admin_field->select_radio == 2 || empty($admin_field->select_radio)) echo "style='display: none'" ?>>
	...
	<div class="field_image_wrap js-imageWrap">
	    <img src="<?= $admin_field->training_media; ?>" alt="" class="js-settingImage field_image">
	...
	<div class="field_image_wrap js-imageWrap">
	    <img src="<?= $admin_field->sns_qr_media; ?>" alt="" class="js-settingImage field_image">
	...
	<div class="field_image_wrap js-imageWrap">
	    <img src="<?= $admin_field->hp_qr_media; ?>" alt="" class="js-settingImage field_image">
